...
class SystemOrigin(FileOrigin):
    ''' File is created by the system, like a directory.'''
    def __init__(self):
        pass

class ProjectOrigin(FileOrigin):
    ''' File is part of a project owned by a repository, perhaps.'''
    def __init__(self):
        pass

class GenerateOrigin(FileOrigin):
    ''' File is generated by a generator tool, such as boilermaker.'''
    def __init__(self):
        pass

class CompileOrigin(FileOrigin):
    ''' File is created by a compile operation.'''
    def __init__(self):
        pass

class ArchiveOrigin(FileOrigin):
    ''' File is created by an archive operation, like a static library.'''
    def __init__(self):
        pass

class LinkOrigin(FileOrigin):
    ''' File is created by a link operation, like an executable or shared library.'''
    def __init__(self):
        pass
